...
import {default as AbstractGridScrollSync, GridReactNodeProvider, Key} from './abstractGridScrollSync';
import {default as AbstractScrollSync} from "./abstractScrollSync";
...
import DebouncedFunction = Utils.DebouncedFunction;
...
export default abstract class AbstractGridReactNodeProvider<S extends AbstractGridScrollSync = AbstractGridScrollSync,
  ...
  protected constructor(protected scrollSync: S) {
    ...
    if (this.shouldHandleMouseEnter())
      this.updateMouseEnterDebounced = Utils.debounce<number>(this.updateMouseEnter, this.getOnMouseEnterDebounceTimeout());

    // noinspection MagicNumberJS
    this.checkForMissingCellsDebounced = Utils.debounce<boolean>(this.checkForMissingCells, this.getScrollDebounceTimeout());
